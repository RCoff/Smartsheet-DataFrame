...
class TestSmartsheetDataFrame(unittest.TestCase):
    ...
    @patch('src.smartsheet_dataframe.smartsheet_dataframe._get_from_request')
    def test_get_sheet_as_df_without_token_or_sheet_obj(self, mock_get_from_request):
    ...
    def test_do_request_rate_limit_failure(self, mock_get):
        ...
        mock_response.json.return_value = {"errorCode": 4004}
        mock_get.return_value = mock_response
